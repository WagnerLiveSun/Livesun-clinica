-- SunSet — esquema MySQL completo correspondente a drizzle/schema.ts
-- Execute em uma instalação vazia do MySQL 8.0+.
CREATE DATABASE IF NOT EXISTS `sunset` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `sunset`;
